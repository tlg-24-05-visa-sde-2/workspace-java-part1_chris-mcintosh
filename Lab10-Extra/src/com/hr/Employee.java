...
public class Employee {
    ...
    /*
     * OPTION 4: try-catch, and throuw a different on back at client.
     * We "nest" or "wrap" the low-level transportation-oriented
     */
     ...
     * NOTE: it is still critical that "stop()" gets called
     */
    /*
    public void goToWork() throws DestinationUnreachableException {
        Car c = new Car("ABC123", "Toyota", "RAV4");
