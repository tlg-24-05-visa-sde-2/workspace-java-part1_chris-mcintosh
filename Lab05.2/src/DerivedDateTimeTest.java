...
//         testAnniversary();
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate valentinesDay = LocalDate.of(2017, 2, 14);
        LocalDate ValentinesBirth = valentinesDay.plusWeeks(38);
        System.out.println(ValentinesBirth);

        // what is the average birthday of someone conceived on New Year's Eve (after midnight)?
        LocalDate NYE = LocalDate.of(2023, 1, 1);
        LocalDate birth = NYE.plusWeeks(38);
    ...
    public static void testLaborDay() {
        LocalDate sept1 = LocalDate.of(1997, 9, 01);
